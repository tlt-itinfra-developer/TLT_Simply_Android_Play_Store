...
public class SwipeTarget extends Target {

    public SwipeTarget(Shape shape, PointF point, View overlay, long duration, TimeInterpolator animation, OnTargetStateChangedListener listener) {
    ...
    public static class Builder extends AbstractTargetBuilder<Builder, SwipeTarget> {
        ...
        public SwipeTarget build() {
            View overlay = getContext().getLayoutInflater().inflate(R.layout.item_tutorial_screen2, null);
        ...
        private void calculatePosition(final PointF point, final Shape shape, View overlay) {
            ...
            layout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    layout.setY(point.y - shape.getHeight() - layout.getHeight() - 15);
                }
            });
        }
    }
