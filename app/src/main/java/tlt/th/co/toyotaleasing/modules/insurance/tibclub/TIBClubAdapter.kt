...
class TIBClubAdapter(private val itemList: ArrayList<TIBClubViewModel.Model>,
                     private val listener: OnEventClickListener) : RecyclerView.Adapter<TIBClubAdapter.ViewHolder>() {
    ...
    fun updateItems(items: ArrayList<TIBClubViewModel.Model>) {
        itemList.clear()
    ...
    interface OnEventClickListener {
        fun onClick(item: TIBClubViewModel.Model)
    }
}