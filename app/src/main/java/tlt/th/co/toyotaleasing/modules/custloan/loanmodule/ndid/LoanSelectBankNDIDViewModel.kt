...
class LoanSelectBankNDIDViewModel  : BaseViewModel() {
...
//        whenLoading.value = true
        ...
        apiLoanManager.getListIDP(request ){ isError, result, step, msg ->
//            whenLoading.value = false
    ...
    fun submit(refID: String  , nodeID: String , indCode: String , compCode: String , ndidID: String  , tltmsg: String) {
        ...
        var request = NDIDRequest.build(
                ...
                ndid_id = ndidID ,
                tltMsg = tltmsg )
        apiLoanManager.requestNDID(request) { isError, result, step, msg ->
            whenLoading.value = false
            if (isError) {
                whenLoading.value = false
                if (result != "device logon") {
