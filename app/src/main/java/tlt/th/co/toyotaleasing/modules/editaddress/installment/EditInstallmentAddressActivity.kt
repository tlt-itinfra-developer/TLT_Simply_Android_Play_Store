...
import kotlinx.android.synthetic.main.activity_edit_installment_address.*
import tlt.th.co.toyotaleasing.R
import tlt.th.co.toyotaleasing.analytics.AnalyticsManager
import tlt.th.co.toyotaleasing.common.base.BaseActivity
import tlt.th.co.toyotaleasing.common.extension.ifFalse

class EditInstallmentAddressActivity : BaseActivity() {

    private val TAB_SELECT_POSITION_STATE = "tablayout_current_position"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_edit_installment_address)
    ...
    companion object {
        fun open(context: Context) {
            val intent = Intent(context, EditInstallmentAddressActivity::class.java)
