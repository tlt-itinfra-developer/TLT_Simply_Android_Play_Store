...
class ItemFileHistoryWidget : FrameLayout {
    ...
    fun setData(data: FileHistoriesWidget.History) {
        if(data.title == ""){
        ...
        recyclerview_image_histories.adapter = ItemFileHistoryAdapter(data.images)
    }
}