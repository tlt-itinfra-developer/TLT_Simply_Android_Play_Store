package tlt.th.co.toyotaleasing.modules.custloan.loanmodule.basicdetail.common
...
class DopaStatusDialog : BaseDialogFragment() {
    ...
    companion object {
        private const val TAG = "DopaStatusDialog"
        ...
        fun newInstance() = DopaStatusDialog()
